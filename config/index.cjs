...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx5d96f8fb756b3d61',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '5ab6af3f084f91cdb8821cf8f310969b',
  ...
  USERS: [
    {
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'fzLPzSFaz0oMTHm07VoQ6ItRUWLpVzhXlsqZXRlbwmM',
      // 所在省份
      province: '北京',
      // 所在城市
      city: '北京市',
      ...
      openUrl: 'https://weibo.com/u/3967989033',
    ...
    {// 想要发送的人的名字
      ...
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'Lcbo3CvoG_CfBgVD0GJsRm2xZmsIPRlJgqLhbYv4KTY',
      // 所在省份
      province: '甘肃省',
      // 所在城市
      city: '张掖市',
      ...
      horoscopeDateType: '今日',
      // 他点击详情后跳转的页面,你可以设置成微博的热榜，也可以设置成其他，网址一定要填对；不填对也没关系，随便你，会打不开而已。
      openUrl: 'http://gansu.chinatax.gov.cn/col/col5334/index.html',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
        ...
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '哥哥', year: '1995', date: '04-09',
        }
      ],
      // 专属纪念日/倒数日，如果你在这里填写了纪念日/倒数日，就不会计算CUSTOMIZED_DATE_LIST的日子了, 和CUSTOMIZED_DATE_LIST的配置方法相同，可以往下查看，我这里就不重复写了
      customizedDateList: [
  ...
  CALLBACK_TEMPLATE_ID: 'oVqMmm1ZyylwX_KkMByMXY26SbQU4FAU2J0PNXhvoX0',
